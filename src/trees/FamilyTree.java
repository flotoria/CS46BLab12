...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		{  // There's a method in Node that searches for a named node. 
			parentNode = root.getNodeWithName(parent); // If the parent node wasn't found, there must have been something wrong in the 
				// data file. Throw an exception.
			if (parentNode == null) throw new TreeException("Not found");
		}
		...
		{
			parentNode.addChild(new TreeNode(children));
		}
	}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		System.out.println(ancestorsOf1);
		System.out.println(ancestorsOf2);
